...
<body style=" font-family: Lobster;">
    ...
    <!-- /#wrapper -->
        ...
        <div class="mainContent">
            <img src="images/WEB KRITI.png" style="width: 800px; margin-left: 170px; margin-top: 80px;">
        </div>
        <!--modal-->
                ...
                <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <form action="conn.php" method="POST">
                            UserName:<br><input type="text" name="username" id="username" onkeyup="usernam()"class="form-control input-lg" placeholder="Enter Name"><br>
                            Password:<br><input type="password" name="password" id="password" onkeyup="pass()" class="form-control input-lg" placeholder="Enter password"><br>
