...
<body style="font-family: Lobster;">
    ...
    <!-- /#wrapper -->
        ...
        <?php 
         ...
         <?php } ?> 
        <header>
                <img src="images/events.jpg" id="eventlogo">
        </header>
        <div class="mainContent">
        <br><hr>
            <div class="listofeventbox">
            <a href="sexy1.php">
                <div class="event_box">
                    <img src="images/robot.png"><br>
                    Robotics
                </div>
            </a>
            <a href="sexy2.php">
                <div class="event_box">
                    <img src="images/gamiacspicture.png" style="height: 100px; width: 90px;"><br>
                    Gamiacs
                </div>
            </a>
            <a href="sexy3.php">
                <div class="event_box">
                    <img src="images/code.png" style="height: 100px; width: 120px;"><br>
